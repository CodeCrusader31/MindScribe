  ...
  const handleSubmitComment = async (e) => {
    ...
    try {
      const res = await axios.post('/api/comments', {
        ...
        commenterId: user.id, // Using user.id to match your API
        text: commentText,
      });
    ...
    <>
      <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-24'>
          ...
          <Image src={data.authorImg} alt='' width={80} height={80} className='mx-auto mt-6 rounded-full' />
      ...
      <div className="my-12 max-w-[800px] md:mx-auto px-4">
        ...
        {user ? (
          ...
          <div className="mb-6 p-4 bg-yellow-100 rounded-md">
            <p>You must be <Link href="/login" className="text-blue-600 underline hover:text-blue-800">logged in</Link> to post comments.</p>
          </div>
        )}
        ...
        <div className="space-y-4">
          {comments.length > 0 ? (
            comments.map((comment) => (
              <div key={comment._id} className="p-4 bg-gray-50 rounded-md border">
